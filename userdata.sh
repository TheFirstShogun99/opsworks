...
CHEF_SERVER_NAME="my-chef-automate" # The name of your Chef Server
CHEF_SERVER_ENDPOINT="my-chef-automate-uv2qyhrahfdyyebp.ap-southeast-1.opsworks-cm.io" # The FQDN of your Chef Server
...
# optional settings
ROOT_CA_URLS=(https://opsworks-cm-${REGION}-prod-default-assets.s3.amazonaws.com/misc/opsworks-cm-ca-2020-root.pem) # URL to download the Root CA certificate of your Chef Automate server. Change this only if you are using a server with a custom domain.
